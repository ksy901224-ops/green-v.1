...
export const analyzeDocument = async (
  ...
  contentParts.push({
    text: `
      ...
      [일지 정보 추출]
      3. title: 내용을 요약한 구체적인 제목.
      4. content: 업무 내용의 상세 본문을 가능한 누락 없이 추출하세요. 
      5. date: 날짜 (YYYY-MM-DD). 문서 내 날짜가 없으면 오늘.
      6. department: ('영업', '연구소', '건설사업', '컨설팅', '관리') 중 문맥에 맞게 추론.
      7. tags: 상황별 구체적 태그 5~7개.
      8. summary_report: (필수) 전체 내용을 3~4문장으로 요약한 보고서.
